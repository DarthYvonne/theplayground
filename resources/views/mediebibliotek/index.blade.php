...
<style>
  ...
  .pl-track { display: flex; align-items: center; gap: 10px; padding: 8px 10px; border: none; background: none; border-radius: 0; font: inherit; text-align: left; cursor: pointer; color: var(--text); width: 100%; }
  .pl-track:hover { background: var(--hover); }
  .pl-track + .pl-track { border-top: 1px solid #f0f2f5; }
