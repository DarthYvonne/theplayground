...
<div class="card" style="overflow:hidden;">
  @if ($enrollments->isEmpty())
    <div class="card-pad" style="text-align:center;color:var(--muted);">Ingen aktive deltagere endnu.</div>
  @else
    @foreach ($enrollments as $e)
      <div style="display:flex;gap:12px;align-items:center;padding:12px 16px;border-top:1px solid #f0f2f5;">
        ...
        <div style="color:var(--muted);font-size:12px;">tilmeldt {{ $e->enrolled_at?->diffForHumans() }}</div>
      </div>
    @endforeach
  @endif
</div>
